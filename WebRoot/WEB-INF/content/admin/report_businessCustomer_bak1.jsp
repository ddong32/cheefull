...
<head>
    ...
    <script type="text/javascript">
		...
		function getParams(){
			...
			var params    = "&uid="+userIds+"&startdate="+startdate+"&enddate="+enddate+areaName;
			//alert(params);
			return params;
		}
		...
		function search(){
			...
			var reportAdd_a = "http://"+hostname+"/WebReport/ReportServer?reportlet=businessCustomer.cpt&op=view"+params;
