...
<HEAD>
	...
	function audit(id){
	  	var url = "${ctx}/admin/expence!audit.action?type=verAudit";
...
<body class="con_r">
    <form id="listForm" action="${ctx}/admin/expence!verificationData.action" method="post">
    	<div class="pub_inp_bg"><div class="pub_inp">
			<table class="con_table">
				<tr>
					...
					<td align="left" width="120"><s:select name="expence.stat" list="#{'1':'未审','2':'经理','0':'回退'}" headerKey="" headerValue="请选择" /></td>
					...
					<td align="right" width="73">报销人:</td>
					<td align="left" width="120"><s:select cssClass="multiselect" multiple="true" name="expence.proUserIds" id="_usersId" list="userList" listKey="id" listValue="name"/></td>
				</tr>
			</table>
        </div></div>
