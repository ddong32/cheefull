...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//2.双击单行进行审核
        function audit(id){
        	var url = "${ctx}/admin/account_flow!audit.action?type=payFinaneChecked" ;
	...
	<body class="list con_r">
		<form id="listForm" action="${ctx}/admin/account_flow!payFinaneChecked.action" method="post">
			...
			<table id="listTable" class="listTable" cellpadding="0" cellspacing="0">
				...
				<s:iterator value="page.result" var="list" status="status">
					<tr ondblclick="audit('<s:property value="#list[0]"/>');" <s:if test="#status.count%2==1">class="cor"</s:if>>
						<td class="tips <s:if test="#list[1] == 9">red</s:if><s:elseif test="#list[1] == 3">green</s:elseif>">
