...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//2.双击单行进行审核
        function audit(id){
        	var url = "${ctx}/admin/account_flow!audit.action?type=takeFinaneRechecked";
	...
	<body class="list con_r">
		<form id="listForm" action="${ctx}/admin/account_flow!takeFinaneRechecked.action" method="post">
