...
$(document).ready(function(e) {
	...
	$("#bankRunningForm #dog_jzsj").val($("#_br_sksj").val());
	$("#bankRunningForm #bankRunning_je").val($("#bankRunning_je").val())
	bankYe(bankId);
});
		...
		<form id="bankRunningForm" class="validate" action="${ctx}/admin/bank_running!save.action" method="post">
			<table class="enforce_table" id="bankRunningAddFrom" cellpadding="0" cellspacing="0" width="100%" style="font-size: 14px">
				...
				<tr>
					...
					<td align="left">
						<input type="text" class="Wdate" name="bankRunning.jzsj" id="dog_jzsj" size="12" onfocus="WdatePicker()" readonly="true" style="width:110px;" rule="noempty" value=""/>
						<label class="requireField">*</label>
					</td>
				</tr>
				<tr>
