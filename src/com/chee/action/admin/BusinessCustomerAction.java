...
public class BusinessCustomerAction extends BaseAction<BusinessCustomer, Integer> {
    ...
    public void save() {
        String msg = "";
        try {
            msg = this.businessCustomerService.doBusinessCustomerSaveOrUpdate(this.businessCustomer, getLoginUser().getName());
        } catch (Exception e) {
    ...
    public String ajaxFindOrderID() {
        ...
        if ((this.businessCustomer != null) && (!"".equals(this.businessCustomer.getOrderId()))) {
            businessCustomerList = this.businessCustomerService.findOrderID(this.businessCustomer.getOrderId());
        }
    ...
    public String input() {
        if ((this.orderId != null) && (!"".equals(this.orderId))) {
            if (this.ids != null) {
                this.businessCustomer = ((BusinessCustomer) this.businessCustomerService.get(Integer.valueOf(this.ids[0].intValue())));
            }
        } else {
    ...
    public void ajaxBatchDelete() {
        String msg = "";
        try {
            msg = this.businessCustomerService.doBatchDelete(this.ids, this.orderId);
        } catch (Exception e) {
            System.out.println(e.toString());
            msg = e.toString();
        }
    ...
    public void ajaxSktjcw() {
        if (this.ids != null) {
            ...
            for (int i = 0; i < j; i++) {
                ...
                BusinessCustomer businessCustomer = (BusinessCustomer) this.businessCustomerService.load(Integer.valueOf(id));
